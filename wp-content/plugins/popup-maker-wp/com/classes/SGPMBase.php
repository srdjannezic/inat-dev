...
class SGPMBase
{
	...
	public function reviewUsNotice()
	{
		...
		if ($showReviewNotice) {
			...
			$reviewMessage .= sprintf( __("<span class='sgpm-review-text'> You are already a true user of <b>Popup Maker</b> plugin! We hope our features are helpful for the conversion improvement of your site. We'd greatly appreciate if you could take a moment to leave a positive review for us.</span>" , $this->pluginSlug), $this->pluginName);
