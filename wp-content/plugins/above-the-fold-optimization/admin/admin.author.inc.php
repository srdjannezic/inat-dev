<div id="post-body-content" style="padding-bottom:0px;margin-bottom:0px;margin-left:5px;">
	<div class="authorbox">
		<div class="inside" style="width:auto;margin:0px;float:left;position:relative;margin-right:2em;">
			<p style="z-index:999;">Developed by <strong><a href="https://optimization.team/#utm_source=wordpress&amp;utm_medium=plugin&amp;utm_term=optimization&amp;utm_campaign=Above%20The%20Fold%20Optimization" target="_blank">o10n-x</a></strong>
		...
		<div class="inside" style="margin:0px;float:left;font-style:italic;">
			...
			<p>o10n-x has developed a plugin that is able to provide instant (&lt;1ms) page load times, up to 99% HTML data transfer saving and real time HTML (live content). 
			<a href="https://optimization.team/innovation/instant/" class="ws-info" target="_blank">Information</a> / <a href="https://www.fastestwebsite.co/" class="ws-info" target="_blank">Demo (WooCommerce)</a>
