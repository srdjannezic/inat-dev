...
class LAE_Pricing_Table_Widget extends Widget_Base {
        ...
        $this->add_control(
            ...
            [
                ...
                'fields' => [
                    [
                        'name' => 'visibility',
                        'label' => __('Visible?', 'livemesh-el-addons'),
                    ...
                    [
                        'name' => 'discount_price',
                        'type' => Controls_Manager::TEXT,
                        'label' => __('Discount Price', 'livemesh-el-addons'),
                        'label_block' => true,
                    ],
                    [
                        'name' => 'currency',
                        'type' => Controls_Manager::SELECT,
                        'label' => __('Currency', 'livemesh-el-addons'),
                        'label_block' => true,
                        'default' => 'euro',
                        'options' => ['&dollar;'=>'dollar','&euro;'=>'euro','dinar','&pound;'=>'pound'],
                    ],
                    [
                        'name' => 'price_desc',
                        'type' => Controls_Manager::TEXT,
                        'label' => __('Price Description', 'livemesh-el-addons'),
                        'label_block' => true,
                    ],
                    [
                        'name' => 'button_text',
    ...
    protected function render() {
        ...
        <div class="lae-pricing-table lae-grid-container">
            ...
            <?php
            $color_array = ['orange','green','purple','blue'];
            $array_counter = 0;
            foreach ($settings['pricing_plans'] as $pricing_plan) :
                ...
                $discount_price = htmlspecialchars_decode(wp_kses_post($pricing_plan['discount_price']));
                $price_desc = $pricing_plan['price_desc'];
                ...
                $visibility = $pricing_plan['visibility'];
                $currency = htmlspecialchars_decode(wp_kses_post($pricing_plan['currency']));
                //var_dump($currency);
                

                $color = $color_array[$array_counter];
                
                $array_counter ++;
                if($array_counter == 4) $array_counter = 0;
                
                if($visibility == "yes") :

                ?>

                <div class="lae-pricing-plan <?php echo ($highlight ? ' lae-highlight' : ''); ?> <?php echo $column_style; ?> <?php echo $color; ?>">
                    ...
                    <<?php echo $settings['plan_price_tag']; ?> class="lae-plan-price lae-plan-header lae-center">
                        ...
                        <span class="lae-text">
                            ...
                            <h1 class="main-price"><?php echo $currency . wp_kses_post($price_tag); ?></h1>
                            <?php if($discount_price) : ?>
                            <strike><h2 class="discount-price"><?php echo $currency . wp_kses_post($discount_price); ?></h2></strike>
                            <?php endif; ?>
                            <?php if($price_desc) : ?>
                            <span class="price-desc">
                            <?php 
                                echo wp_kses_post($price_desc); 
                            ?> </span>
                            <?php endif; ?>
                        </span>
